...
public struct AssetManager {
    ...
    public static func saveSystemAlbum(forAsset asset: Any,
        ...
        requestAuthorization {
            ...
            DispatchQueue.global().async{
                ...
                do {
                    ...
                    if let placeholder = placeholder, let phAsset = self.fetchAsset(withLocalIdentifier: placeholder.localIdentifier){
    ...
    private static func saveCustomAlbum(for asset: PHAsset,
                                        albumName: String) {
